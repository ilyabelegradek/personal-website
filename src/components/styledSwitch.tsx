  ...
  "& .MuiSwitch-switchBase": {
    ...
    "&.Mui-checked": {
      ...
      "& .MuiSwitch-thumb:before": {
        backgroundImage: `url('data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" height="30" width="30" viewBox="0 0 30 30"><path d="M6.3 3.75l-1.05 2.7-2.7 1.05 2.7 1.05 1.05 2.7 0.9-2.7L9.45 7.5l-2.85-1.05-0.9-2.7zm22.5 12.45a10.05 10.05 0 11-9.9-9.9 8.7 8.7 0 009.9 9.9z"/></svg>')`,
      },
    },
  },
  "& .MuiSwitch-thumb": {
